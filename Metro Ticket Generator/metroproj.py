    ...
    case 1:
        ...
        if arriving_number in stations and destination_number in stations:
            ...
            if destination_number in student_fare_table[arriving_number]:
                ...
                # Calculate the size of the image based on text and QR code size
                ...
                x, y = 70, 300  # Adjust the Y coordinate to place the text below the QR code

                # Define the line height for multiline text
                line_height = 20

                # Paste the QR code image onto the output image
                output_image.paste(qr_image, (50, 50))  # Adjust the Y coordinate to place the QR code higher
                ...
                # Draw each line of text below the QR code image
                for line in lines:
